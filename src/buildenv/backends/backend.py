...
class EnvBackend(ABC):
    ...
    def install(
        ...
        # Delegate to base generation logic (skipping files already generated by the template, if any)
        self._generate_files(self._get_files_descriptors(), all_packages, skipped_files=template.generated_files if template else None)
